...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='profile.php'><h4>รวมแพคเกจ</h4></a></li>
	";
...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>จังหวัด</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>฿.$pro_price.00
									<a href='' style='float:right;' class='btn btn-success btn-xs'>รายละเอียด</a>
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>เพิ่มเข้าตะกร้า</button>
								</div>
							</div>
						</div>	
			";
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>฿.$pro_price.00
								<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>รายละเอียด</button>
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>รายละเอียด</button>
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>เพิ่มเข้าตะกร้า</button>
								</div>
							</div>
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/travel/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/travel/cancel.php"/>
